...
export const HomePage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        "Post created successfully! Processing social media uploads...",
        {
          id: loadingToast,
          duration: 5000,
        },
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Enter either the model ID (e.g., 938881) or the full URL with
                profile ID to fetch specific print settings
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setPostToInstagramStory(!postToInstagramStory)
                    }
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 ${
            ...
            <div className="space-y-4 border-t pt-6">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Gib deutsche Stichwörter ein und klicke auf "Text generieren"
                  für eine englische Beschreibung
                </p>
              </div>
              ...
              <div>
                ...
                />
                <p className="mt-1 text-sm text-gray-500">
                  Du kannst den generierten Text bearbeiten oder eigenen Text
                  eingeben. Leer lassen um zu überspringen.
                </p>
              </div>
            </div>
